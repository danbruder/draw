...
var $author$project$Gen$Route$Room__Id_ = function (a) {
	return {$: 'Room__Id_', a: a};
};
...
var $author$project$Gen$Params$Room$Id_$Params = function (id) {
	return {id: id};
};
...
var $author$project$Gen$Params$Room$Id_$parser = A2(
	$elm$url$Url$Parser$map,
	$author$project$Gen$Params$Room$Id_$Params,
	A2(
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Room__Id_, $author$project$Gen$Params$Room$Id_$parser)
	]);
...
var $author$project$Gen$Model$Room__Id_ = F2(
	function (a, b) {
		return {$: 'Room__Id_', a: a, b: b};
	});
var $author$project$Gen$Msg$Room__Id_ = function (a) {
	return {$: 'Room__Id_', a: a};
};
...
var $author$project$Pages$Room$Id_$BoardMsg = function (a) {
	return {$: 'BoardMsg', a: a};
};
...
var $author$project$Board$init = _Utils_Tuple2(
	...
	$elm$core$Platform$Cmd$none);
var $author$project$Domain$Room$Room = F3(
	function (users, turnOffset, machine) {
		return {machine: machine, turnOffset: turnOffset, users: users};
	});
var $author$project$Domain$Machine$Joining = {$: 'Joining'};
var $author$project$Domain$Machine$init = $author$project$Domain$Machine$Joining;
var $author$project$Domain$Room$init = A3($author$project$Domain$Room$Room, $elm$core$Dict$empty, 0, $author$project$Domain$Machine$init);
var $author$project$Pages$Room$Id_$init = function () {
	var _v0 = $author$project$Board$init;
	var boardModel = _v0.a;
	var boardCmd = _v0.b;
	return _Utils_Tuple2(
		{board: boardModel, me: $elm$core$Maybe$Nothing, nameInput: '', room: $author$project$Domain$Room$init},
		A2($elm$core$Platform$Cmd$map, $author$project$Pages$Room$Id_$BoardMsg, boardCmd));
}();
var $author$project$Pages$Room$Id_$GotMessage = function (a) {
...
var $author$project$Net$rx = _Platform_incomingPort('rx', $elm$json$Json$Decode$value);
var $author$project$Pages$Room$Id_$ServerMsgIn = F2(
	function (me, room) {
		return {me: me, room: room};
	});
var $author$project$Domain$Machine$Drawing = function (a) {
	return {$: 'Drawing', a: a};
};
var $author$project$Domain$Machine$SelectingWord = function (a) {
	return {$: 'SelectingWord', a: a};
};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Domain$DrawingModel$DrawingModel = F5(
	function (artist, word, secondsLeft, frames, guesses) {
		return {artist: artist, frames: frames, guesses: guesses, secondsLeft: secondsLeft, word: word};
	});
var $author$project$Domain$Guess$Guess = F3(
	function (val, correct, user) {
		return {correct: correct, user: user, val: val};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Domain$Guess$decoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Domain$Guess$Guess,
...
var $author$project$Domain$Word$Word = F2(
	function (val, letters) {
		return {letters: letters, val: val};
	});
...
var $author$project$Domain$Word$decoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Domain$Word$Word,
	A2($elm$json$Json$Decode$field, 'val', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'letters',
...
var $author$project$Domain$DrawingModel$decoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Domain$DrawingModel$DrawingModel,
	A2($elm$json$Json$Decode$field, 'artist', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'word', $author$project$Domain$Word$decoder),
	A2($elm$json$Json$Decode$field, 'seconds_left', $elm$json$Json$Decode$int),
	A2(
		$elm$json$Json$Decode$field,
		'frames',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$value)),
	A2(
		$elm$json$Json$Decode$field,
		'guesses',
		$elm$json$Json$Decode$list($author$project$Domain$Guess$decoder)));
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Domain$Machine$decoder = function () {
	var msgFromType = function (ty) {
		switch (ty) {
			case 'Joining':
				return $elm$json$Json$Decode$succeed($author$project$Domain$Machine$Joining);
			case 'SelectingWord':
				return A2(
					$elm$json$Json$Decode$andThen,
					function (artist) {
						return $elm$json$Json$Decode$succeed(
							$author$project$Domain$Machine$SelectingWord(
								{artist: artist}));
					},
					A2($elm$json$Json$Decode$field, 'artist', $elm$json$Json$Decode$string));
			case 'Drawing':
				return A2(
					...
					function (drawing) {
						return $elm$json$Json$Decode$succeed(
							$author$project$Domain$Machine$Drawing(drawing));
					},
					$author$project$Domain$DrawingModel$decoder);
			default:
				return $elm$json$Json$Decode$fail('Unknown server message');
		}
	};
	return A2(
		$elm$json$Json$Decode$andThen,
...
var $author$project$Domain$User$User = F2(
	function (name, points) {
		return {name: name, points: points};
	});
var $author$project$Domain$User$decoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Domain$User$User,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'points', $elm$json$Json$Decode$int));
var $author$project$Domain$Room$decoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Domain$Room$Room,
	A2(
		$elm$json$Json$Decode$field,
		'users',
		$elm$json$Json$Decode$dict($author$project$Domain$User$decoder)),
	A2($elm$json$Json$Decode$field, 'turn_offset', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'machine', $author$project$Domain$Machine$decoder));
var $author$project$Pages$Room$Id_$serverMsgInDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Pages$Room$Id_$ServerMsgIn,
	A2($elm$json$Json$Decode$field, 'me', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'payload', $author$project$Domain$Room$decoder));
var $author$project$Board$AnimationFrame = function (a) {
...
var $author$project$Board$subscriptions = function (model) {
	return $elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Board$AnimationFrame);
};
var $author$project$Pages$Room$Id_$subscriptions = function (model) {
	var doDecode = function (val) {
		return A2(
			$elm$core$Result$mapError,
			function (err) {
				var _v0 = A2($elm$core$Debug$log, 'err', err);
				return 'Invalid';
			},
			A2($elm$json$Json$Decode$decodeValue, $author$project$Pages$Room$Id_$serverMsgInDecoder, val));
	};
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(
				$elm$core$Platform$Sub$map,
				$author$project$Pages$Room$Id_$BoardMsg,
				$author$project$Board$subscriptions(model.board)),
				$author$project$Net$rx(
...
var $author$project$Canvas$Encode$encodeColor = function (color) {
	return $elm$json$Json$Encode$string(
		$avh4$elm_color$Color$toCssString(color));
};
var $author$project$Canvas$Encode$encodeDrawOp = function (op) {
	switch (op.$) {
		case 'NotSpecified':
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('NotSpecified'))
					]));
		case 'Fill':
			var color = op.a;
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('Fill')),
						_Utils_Tuple2(
						'color',
						$author$project$Canvas$Encode$encodeColor(color))
					]));
		case 'Stroke':
			var color = op.a;
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('Stroke')),
						_Utils_Tuple2(
						'color',
						$author$project$Canvas$Encode$encodeColor(color))
					]));
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('FillAndStroke')),
						_Utils_Tuple2(
						'color1',
						$author$project$Canvas$Encode$encodeColor(c1)),
						_Utils_Tuple2(
						'color2',
						$author$project$Canvas$Encode$encodeColor(c2))
					]));
	}
};
var $elm$json$Json$Encode$float = _Json_wrap;
var $author$project$Canvas$Encode$encodePoint = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
...
var $author$project$Canvas$Encode$encodeSegment = function (segment) {
	if (segment.$ === 'QuadraticCurveTo') {
		var point1 = segment.a;
		var point2 = segment.b;
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'type',
					$elm$json$Json$Encode$string('QuadraticCurveTo')),
					_Utils_Tuple2(
					'point1',
					$author$project$Canvas$Encode$encodePoint(point1)),
					_Utils_Tuple2(
					'point2',
					$author$project$Canvas$Encode$encodePoint(point2))
				]));
	} else {
		return $elm$json$Json$Encode$null;
	}
};
var $author$project$Canvas$Encode$encodeShape = function (shape) {
	if (shape.$ === 'Path') {
		var point = shape.a;
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'point',
					$author$project$Canvas$Encode$encodePoint(point)),
					_Utils_Tuple2(
					'segments',
					A2($elm$json$Json$Encode$list, $author$project$Canvas$Encode$encodeSegment, segments))
				]));
	} else {
		return $elm$json$Json$Encode$null;
	}
};
var $author$project$Canvas$Encode$encodeDrawable = function (drawable) {
	if (drawable.$ === 'DrawableShapes') {
		var shapes = drawable.a;
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'type',
					$elm$json$Json$Encode$string('DrawableShapes')),
					_Utils_Tuple2(
					'shapes',
					A2($elm$json$Json$Encode$list, $author$project$Canvas$Encode$encodeShape, shapes))
				]));
	} else {
		return $elm$json$Json$Encode$null;
	}
};
var $author$project$Canvas$encodeRenderable = function (_v0) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'commands',
				A2($elm$json$Json$Encode$list, $elm$core$Basics$identity, commands)),
				_Utils_Tuple2(
				'drawOp',
				$author$project$Canvas$Encode$encodeDrawOp(drawOp)),
				_Utils_Tuple2(
				'drawable',
				$author$project$Canvas$Encode$encodeDrawable(drawable))
			]));
};
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'frames',
						A2($elm$json$Json$Encode$list, $author$project$Canvas$encodeRenderable, frames)),
						_Utils_Tuple2(
						'type',
...
var $author$project$Pages$Room$Id_$send = A2($elm$core$Basics$composeR, $author$project$Pages$Room$Id_$encodeServerMsgOut, $author$project$Net$tx);
var $author$project$Board$controlPoint = F2(
	function (_v0, _v1) {
		var x1 = _v0.a;
		var y1 = _v0.b;
		var x2 = _v1.a;
...
var $author$project$Canvas$Settings$Line$RoundCap = {$: 'RoundCap'};
var $author$project$Canvas$Settings$Line$RoundJoin = {$: 'RoundJoin'};
...
var $author$project$Board$getShadowColor = function (color) {
...
var $author$project$Canvas$Internal$CustomElementJsonApi$lineCap = function (cap) {
	return A2(
		$author$project$Canvas$Internal$CustomElementJsonApi$field,
		'lineCap',
		$elm$json$Json$Encode$string(cap));
};
var $author$project$Canvas$Settings$Line$lineCapToString = function (cap) {
	switch (cap.$) {
		case 'ButtCap':
			return 'butt';
		case 'RoundCap':
...
var $author$project$Canvas$Settings$Line$lineCap = function (cap) {
	return $author$project$Canvas$Internal$Canvas$SettingCommand(
		$author$project$Canvas$Internal$CustomElementJsonApi$lineCap(
			$author$project$Canvas$Settings$Line$lineCapToString(cap)));
};
var $author$project$Canvas$Internal$CustomElementJsonApi$lineJoin = function (join) {
	return A2(
		$author$project$Canvas$Internal$CustomElementJsonApi$field,
		'lineJoin',
		$elm$json$Json$Encode$string(join));
};
var $author$project$Canvas$Settings$Line$lineJoinToString = function (join) {
	switch (join.$) {
		case 'BevelJoin':
			return 'bevel';
		case 'RoundJoin':
...
var $author$project$Canvas$Settings$Line$lineJoin = function (join) {
	return $author$project$Canvas$Internal$Canvas$SettingCommand(
		$author$project$Canvas$Internal$CustomElementJsonApi$lineJoin(
			$author$project$Canvas$Settings$Line$lineJoinToString(join)));
};
var $author$project$Canvas$Internal$CustomElementJsonApi$lineWidth = function (value) {
	return A2(
		$author$project$Canvas$Internal$CustomElementJsonApi$field,
		'lineWidth',
		$elm$json$Json$Encode$float(value));
};
var $author$project$Canvas$Settings$Line$lineWidth = function (width) {
	return $author$project$Canvas$Internal$Canvas$SettingCommand(
		$author$project$Canvas$Internal$CustomElementJsonApi$lineWidth(width));
};
var $author$project$Canvas$Internal$Canvas$SettingCommands = function (a) {
	return {$: 'SettingCommands', a: a};
};
var $author$project$Canvas$Internal$CustomElementJsonApi$shadowBlur = function (value) {
	return A2(
		$author$project$Canvas$Internal$CustomElementJsonApi$field,
		'shadowBlur',
		$elm$json$Json$Encode$float(value));
};
var $author$project$Canvas$Internal$CustomElementJsonApi$shadowColor = function (color) {
	return A2(
		$author$project$Canvas$Internal$CustomElementJsonApi$field,
		'shadowColor',
...
var $author$project$Canvas$Internal$CustomElementJsonApi$shadowOffsetX = function (value) {
	return A2(
		$author$project$Canvas$Internal$CustomElementJsonApi$field,
		'shadowOffsetX',
		$elm$json$Json$Encode$float(value));
};
var $author$project$Canvas$Internal$CustomElementJsonApi$shadowOffsetY = function (value) {
	return A2(
		$author$project$Canvas$Internal$CustomElementJsonApi$field,
		'shadowOffsetY',
		$elm$json$Json$Encode$float(value));
};
var $author$project$Canvas$Settings$Advanced$shadow = function (_v0) {
	var blur = _v0.blur;
	var color = _v0.color;
	...
	return $author$project$Canvas$Internal$Canvas$SettingCommands(
		_List_fromArray(
			[
				$author$project$Canvas$Internal$CustomElementJsonApi$shadowBlur(blur),
				$author$project$Canvas$Internal$CustomElementJsonApi$shadowColor(color),
				$author$project$Canvas$Internal$CustomElementJsonApi$shadowOffsetX(x),
				$author$project$Canvas$Internal$CustomElementJsonApi$shadowOffsetY(y)
			]));
};
...
var $author$project$Canvas$Settings$stroke = function (color) {
	return $author$project$Canvas$Internal$Canvas$SettingDrawOp(
		$author$project$Canvas$Internal$Canvas$Stroke(color));
};
var $author$project$Board$drawLine = F2(
	function (_v0, line) {
		var color = _v0.color;
		var size = _v0.size;
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Canvas$Settings$Line$lineCap($author$project$Canvas$Settings$Line$RoundCap),
					$author$project$Canvas$Settings$Line$lineJoin($author$project$Canvas$Settings$Line$RoundJoin),
					$author$project$Canvas$Settings$Line$lineWidth(size),
					$author$project$Canvas$Settings$Advanced$shadow(
					{
						blur: 10,
						color: $author$project$Board$getShadowColor(color),
						offset: _Utils_Tuple2(0, 0)
					}),
					$author$project$Canvas$Settings$stroke(color)
				]),
			line);
	});
var $author$project$Canvas$Internal$Canvas$Path = F2(
	function (a, b) {
		return {$: 'Path', a: a, b: b};
	});
var $author$project$Canvas$path = F2(
	function (startingPoint, segments) {
		return A2($author$project$Canvas$Internal$Canvas$Path, startingPoint, segments);
	});
var $author$project$Canvas$Internal$Canvas$QuadraticCurveTo = F2(
	function (a, b) {
		return {$: 'QuadraticCurveTo', a: a, b: b};
	});
var $author$project$Canvas$quadraticCurveTo = F2(
	function (controlPoint, point) {
		return A2($author$project$Canvas$Internal$Canvas$QuadraticCurveTo, controlPoint, point);
	});
var $author$project$Board$drawPoint = F3(
	function (newPoint, _v0, model) {
		var previousMidpoint = _v0.previousMidpoint;
		var lastPoint = _v0.lastPoint;
		var pending = model.pending;
		var newMidPoint = A2($author$project$Board$controlPoint, lastPoint, newPoint);
		return _Utils_update(
			model,
			{
				...
				pending: A2(
					$elm$core$Array$push,
					A2(
						$author$project$Board$drawLine,
						model,
						_List_fromArray(
							[
								A2(
								$author$project$Canvas$path,
								previousMidpoint,
								_List_fromArray(
									[
										A2($author$project$Canvas$quadraticCurveTo, lastPoint, newMidPoint)
									]))
							])),
					pending)
			});
	});
var $author$project$Board$finalPoint = F3(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($author$project$Canvas$quadraticCurveTo, lastPoint, point)
									]))
							])),
					pending)
			});
	});
var $author$project$Board$flushPendingToDraw = function (model) {
	var pending = model.pending;
	return _Utils_update(
		model,
		{
...
var $author$project$Board$incFrames = function (model) {
	var frames = model.frames;
	return _Utils_update(
		model,
		{frames: frames + 1});
};
var $author$project$Board$initialPoint = F2(
...
var $author$project$Board$selectColor = F2(
	function (color, model) {
		return _Utils_update(
			model,
			{color: color});
	});
var $author$project$Board$selectSize = F2(
	function (size, model) {
		return _Utils_update(
			model,
			{size: size});
		...
		return _Utils_Tuple2(
			function () {
				switch (msg.$) {
					case 'AnimationFrame':
						var delta = msg.a;
						return $author$project$Board$flushPendingToDraw(
							$author$project$Board$incFrames(model));
					case 'StartAt':
						var point = msg.a;
						return A2($author$project$Board$initialPoint, point, model);
					case 'MoveAt':
						var point = msg.a;
						if (drawingPointer.$ === 'Just') {
							var pointer = drawingPointer.a;
							return A3($author$project$Board$drawPoint, point, pointer, model);
						} else {
							return model;
						}
					case 'EndAt':
						...
						if (drawingPointer.$ === 'Just') {
							var pointer = drawingPointer.a;
							return A3($author$project$Board$finalPoint, point, pointer, model);
						} else {
							return model;
						}
					case 'SelectColor':
						var color = msg.a;
						return A2($author$project$Board$selectColor, color, model);
					default:
						var size = msg.a;
						return A2($author$project$Board$selectSize, size, model);
				}
			}(),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Pages$Room$Id_$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ClickedSetName':
				return _Utils_Tuple2(
					...
					$author$project$Pages$Room$Id_$send(
						$author$project$Pages$Room$Id_$SetName(
							{
			...
			case 'ClickedWord':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{nameInput: ''}),
					$author$project$Pages$Room$Id_$send(
						$author$project$Pages$Room$Id_$SetWord(
							{
								id: A2($elm$core$Maybe$withDefault, '', model.me),
								word: word
							})));
			case 'TypedInNameField':
				var name = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'GotMessage':
				var serverMsg = msg.a;
				if (serverMsg.$ === 'Ok') {
					var me = serverMsg.a.me;
					var room = serverMsg.a.room;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								me: $elm$core$Maybe$Just(me),
								room: room
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Board$EndAt = function (a) {
	return {$: 'EndAt', a: a};
};
var $author$project$Board$MoveAt = function (a) {
	return {$: 'MoveAt', a: a};
};
var $author$project$Board$StartAt = function (a) {
	return {$: 'StartAt', a: a};
};
...
var $author$project$Board$col = function (btns) {
	return A2($elm$html$Html$div, _List_Nil, btns);
};
var $author$project$Board$SelectColor = function (a) {
	return {$: 'SelectColor', a: a};
};
var $author$project$Board$colorButton = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Board$SelectColor(color))
				]),
			_List_Nil);
	});
...
var $author$project$Board$colorButtons = function (selectedColor) {
	var layout = function (colors) {
		return A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$elm$core$List$map(
					$author$project$Board$colorButton(selectedColor)),
				$author$project$Board$col),
			colors);
	};
	return A2(
		$elm$html$Html$div,
...
var $author$project$Board$h = 500;
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$eventDecoder = A5(
	...
	A2(
		...
		'touches',
		$mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$touchListDecoder($mpizenberg$elm_pointer_events$Html$Events$Extra$Touch$touchDecoder)));
var $author$project$Board$offsetDecoder = A2(
	$elm$json$Json$Decode$field,
	'target',
	A3(
		$elm$json$Json$Decode$map2,
...
var $author$project$Board$eventDecoder = A3(
	$elm$json$Json$Decode$map2,
	F2(
	...
	$author$project$Board$offsetDecoder);
var $author$project$Board$onTouch = F2(
	function (event, tag) {
		return A2(
			$elm$html$Html$Events$custom,
			event,
			A2(
				...
				$author$project$Board$eventDecoder));
	});
...
var $author$project$Board$SelectSize = function (a) {
	return {$: 'SelectSize', a: a};
};
var $author$project$Board$sizeControls = F2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'outline', 'none'),
							$elm$html$Html$Events$onClick(
							$author$project$Board$SelectSize(size))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									'3px solid ' + $avh4$elm_color$Color$toCssString(
										$author$project$Board$getShadowColor($avh4$elm_color$Color$white))),
									A2(
									$elm$html$Html$Attributes$style,
									'width',
...
var $author$project$Canvas$Internal$CustomElementJsonApi$clearRect = F4(
...
var $author$project$Canvas$renderClear = F4(
	function (_v0, w, h, cmds) {
		var x = _v0.a;
		var y = _v0.b;
		return A2(
			$elm$core$List$cons,
			A4($author$project$Canvas$Internal$CustomElementJsonApi$clearRect, x, y, w, h),
			cmds);
	});
	...
	function (drawable, drawOp, cmds) {
		switch (drawable.$) {
			...
			default:
				...
				var w = drawable.b;
				var h = drawable.c;
				return A4($author$project$Canvas$renderClear, p, w, h, cmds);
		}
	});
...
var $author$project$Canvas$Internal$Texture$decodeTextureImage = A2(
	$elm$json$Json$Decode$andThen,
	function (image) {
		return A4(
			$elm$json$Json$Decode$map3,
...
var $author$project$Canvas$Internal$Texture$decodeImageLoadEvent = A2($elm$json$Json$Decode$field, 'target', $author$project$Canvas$Internal$Texture$decodeTextureImage);
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$on,
					'load',
					A2($elm$json$Json$Decode$map, onLoad, $author$project$Canvas$Internal$Texture$decodeImageLoadEvent)),
					A2(
					$elm$html$Html$Events$on,
					'error',
...
var $author$project$Canvas$toHtml = F3(
...
var $author$project$Board$touchCoordinates = function (_v0) {
	var event = _v0.event;
	var targetOffset = _v0.targetOffset;
	return A2(
		$elm$core$Maybe$withDefault,
		_Utils_Tuple2(0, 0),
		A2(
...
var $author$project$Board$w = 500;
var $author$project$Board$view = function (_v0) {
	var color = _v0.color;
	var size = _v0.size;
	var toDraw = _v0.toDraw;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A3(
				$author$project$Canvas$toHtml,
				_Utils_Tuple2($author$project$Board$w, $author$project$Board$h),
				_List_fromArray(
					[
						...
						A2(
							...
							$author$project$Board$EndAt)),
						A2(
						$author$project$Board$onTouch,
						'touchstart',
						A2($elm$core$Basics$composeR, $author$project$Board$touchCoordinates, $author$project$Board$StartAt)),
						A2(
						$author$project$Board$onTouch,
						'touchmove',
						A2($elm$core$Basics$composeR, $author$project$Board$touchCoordinates, $author$project$Board$MoveAt)),
						A2(
						$author$project$Board$onTouch,
						'touchend',
						A2($elm$core$Basics$composeR, $author$project$Board$touchCoordinates, $author$project$Board$EndAt))
					]),
				toDraw),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'max-width',
						$elm$core$String$fromInt($author$project$Board$w - 20) + 'px'),
						A2($elm$html$Html$Attributes$style, 'padding', '10px')
					]),
				_List_fromArray(
					[
						A2($author$project$Board$sizeControls, color, size),
						$author$project$Board$colorButtons(color)
					]))
			]));
};
var $author$project$Pages$Room$Id_$viewDrawing = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Drawing time')
						])),
					A2(
...
var $author$project$Pages$Room$Id_$ClickedWord = function (a) {
	return {$: 'ClickedWord', a: a};
};
...
var $author$project$Pages$Room$Id_$sampleWords = _List_fromArray(
	['House', 'Garden', 'Superman', 'Cheese', 'Fire', 'Couch', 'Tree']);
var $rtfeldman$elm_css$Html$Styled$ul = $rtfeldman$elm_css$Html$Styled$node('ul');
var $author$project$Pages$Room$Id_$viewSelectAWord = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Select A Word')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						A2(
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											$author$project$Pages$Room$Id_$ClickedWord(i))
										]),
									_List_fromArray(
										[
							...
							$author$project$Pages$Room$Id_$sampleWords))
					]))
			]));
};
var $author$project$Pages$Room$Id_$viewSomeoneElseIsSelectingAWord = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Someone else is selecting a word')
					]))
			]));
};
...
var $author$project$Pages$Room$Id_$viewUserJoin = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Please enter your name')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$form,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onSubmit($author$project$Pages$Room$Id_$ClickedSetName)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Room$Id_$TypedInNameField),
								$rtfeldman$elm_css$Html$Styled$Attributes$value(model.nameInput)
							]),
						_List_Nil),
						A2(
						$rtfeldman$elm_css$Html$Styled$input,
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Html$Styled$Attributes$value('Let\'s go!')
							]),
						_List_Nil)
					])),
				A2(
						...
						A2(
							...
							function (i) {
								return A2(
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text(i.name)
										]));
							},
...
var $author$project$Pages$Room$Id_$view = function (model) {
	return {
		body: _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							...
							function () {
							var _v0 = model.room.machine;
							switch (_v0.$) {
								case 'Joining':
									return $author$project$Pages$Room$Id_$viewUserJoin(model);
								case 'SelectingWord':
									var artist = _v0.a.artist;
									return _Utils_eq(
										$elm$core$Maybe$Just(artist),
										model.me) ? $author$project$Pages$Room$Id_$viewSelectAWord(model) : $author$project$Pages$Room$Id_$viewSomeoneElseIsSelectingAWord(model);
								default:
									var drawing = _v0.a;
									return A2($author$project$Pages$Room$Id_$viewDrawing, drawing, model);
							}
						}()
						])))
			]),
...
var $author$project$Pages$Room$Id_$page = F2(
	function (shared, req) {
		return $author$project$Page$element(
			{init: $author$project$Pages$Room$Id_$init, subscriptions: $author$project$Pages$Room$Id_$subscriptions, update: $author$project$Pages$Room$Id_$update, view: $author$project$Pages$Room$Id_$view});
	});
	...
	body: _List_fromArray(
		[
			...
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Welcome to draw with friends! Let\'s create a board')
					])))
		]),
	title: 'Homepage'
};
...
var $author$project$Gen$Pages$pages = {
	...
	room__id_: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Room$Id_$page, $author$project$Gen$Model$Room__Id_, $author$project$Gen$Msg$Room__Id_)
};
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Room__Id_':
			var params = route.a;
			return $author$project$Gen$Pages$pages.room__id_.init(params);
		default:
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Room__Id_':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.room__id_.subscriptions, params, model);
		default:
			var params = model_.a;
...
var $author$project$Gen$Pages$update = F2(
	function (msg_, model_) {
		...
		if (_v0.b.$ === 'Room__Id_') {
			...
			var params = _v1.a;
			var model = _v1.b;
			return A3($author$project$Gen$Pages$pages.room__id_.update, params, msg, model);
		} else {
			return F3(
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Room__Id_':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.room__id_.view, params, model);
		default:
			var params = model_.a;
