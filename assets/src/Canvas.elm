...
encodeRenderable : Renderable -> JE.Value
encodeRenderable (Renderable { commands, drawOp, drawable }) =
    JE.object
        [ ( "commands", JE.list identity commands )
        , ( "drawOp", Canvas.Encode.encodeDrawOp drawOp )
        , ( "drawable", Canvas.Encode.encodeDrawable drawable )
        ]
